...
<head>
    ...
    <title>Past Events | Zilla Parishad Palghar</title>
    ...
    <div class="bg-[#F6F3EE]">
        <div class="max-w-7xl min-h-[600px] mx-auto px-4 py-3">
            ...
            <div class="max-w-7xl mx-auto py-6 flex justify-between items-center">
                <h1 class="text-[28px]">Past Events</h1>
            ...
            <div id="gridView" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 mb-8">
                ...
                <div class="relative bg-white shadow-md min-h-[400px] flex flex-col">
                    ...
                    <div class="relative p-4 pb-8 flex-1 flex flex-col justify-between gap-y-4">
                        ...
                        <div class="text-center">
                            <div class="space-y-3">
                                <h3 class="text-sm font-semibold">Constitution Day celebrated at Zilla Parishad Palghar</h3>
                                ...
                                <div class="border border-gray-300 w-full  px-4 py-2">
                                    <span class="text-sm text-center">Posted on: 1st January, 2025</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="relative bg-white shadow-md min-h-[400px] flex flex-col">
                    ...
                    <div class="relative p-4 pb-8 flex-1 flex flex-col justify-between gap-y-4">
                        ...
                        <div class="text-center">
                            <div class="space-y-3">
                                <h3 class="text-sm font-semibold">Successful program of health check-up of beneficiaries migrated to brick kilns in Palghar district</h3>
                                <p class="text-sm text-gray-600">Date 21/12/2024 Zilla Parishad Palghar As per the orders of the Chief Executive Officer, Zilla Parishad Palghar, a special program…</p>
            ...
            <div id="listView" class="hidden grid-rows-2 gap-y-8">
                    ...
                    <div class="relative p-4 flex flex-col justify-between gap-y-4">
                        ...
                        <div class="flex gap-x-4 justify-between items-center">
                            <div class="space-y-3 w-[80%]">
                                <h2 class="text-base font-semibold">Constitution Day celebrated at Zilla Parishad Palghar</h2>
                                <p class="text-sm text-gray-600">Constitution Day was celebrated at Zilla Parishad Palghar today on 26/11/2024. Chief Executive Officer Bhanudas Palve, Additional Chief Executive Officer…</p>
                                ...
                                <div class="flex gap-x-4">
                                    ...
                                    <div class="border border-gray-300 w-fit  px-4 py-2">
                                        <span class="text-sm text-center">Posted on: 1st January, 2025</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class=" bg-white shadow-md flex">
                    ...
                    <div class="relative p-4 flex flex-col justify-between gap-y-4">
                        ...
                        <div class="flex gap-x-4 justify-between items-center">
                            <div class="space-y-3 w-[80%]">
                                <h2 class="text-base font-semibold">Successful program of health check-up of beneficiaries migrated to brick kilns in Palghar district</h2>
                                <p class="text-sm text-gray-600">Date 21/12/2024 Zilla Parishad Palghar As per the orders of the Chief Executive Officer, Zilla Parishad Palghar, a special program…</p>
