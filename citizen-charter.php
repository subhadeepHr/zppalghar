...
<head>
    ...
    <title>Citizen Charter | Zilla Parishad Palghar | India</title>
        ...
        <div class="max-w-7xl mx-auto px-4 py-3">
            <div class="flex justify-between items-center">
                ...
                <nav class="text-sm">
                    ...
                    <span class="mx-2 text-gray-500">></span>
                    <span class="text-gray-700">Citizen Charter</span>
                </nav>
            ...
            <div class=" md:basis-[75%] w-full px-6 py-8 flex justify-center items-center">
                <div class="flex">
                    <select name="" id="categoryFilter" class="min-w-40 md:w-72 lg:w-[570px] p-1">
                        ...
                        <option value="citizen_charter" selected>Citizen Charter</option>
