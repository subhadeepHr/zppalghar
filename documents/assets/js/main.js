  ...
  function handleFilterRedirect() {
    ...
    if (filterSelect && filterButton) {
      filterButton.addEventListener("click", function (e) {
        ...
        if (targetPage) {
          // Check if we're in the documents folder or root
          ...
          if (isInDocumentsFolder) {
            // If we're in documents folder, navigate directly to the page
            window.location.href = targetPage;
          } else {
            // If we're in root, navigate to documents folder first
            window.location.href = "documents/" + targetPage;
          }
        }
      });
