      ...
      <div class="max-w-7xl mx-auto ">
          <div class="flex items-center justify-between">
              ...
              <div class="flex items-center space-x-4">
                  ...
                  <div>
                      <span lang="mr" class="text-lg">
                          जिल्हा परिषद पालघर </span>
  ...
  <nav class="bg-offWhite shadow-lg relative z-50">
      <div class="max-w-7xl mx-auto">
          <div class="flex items-center justify-between">
              <ul class="flex items-center font-semibold text-black">
                  <li class="nav-item">
              ...
              <button id="openSidebar" class="text-gray-700 hover:text-gray-900 p-2">
              ...
              <!-- <div class="flex items-center space-x-2 pr-4">
                  <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu">
                          <a href="#" class="dropdown-item">Annual Publications</a>
  ...
  <!-- Sidebar -->
  <div id="sidebar" class="fixed top-0 right-0 w-64 h-full bg-[#fbac1b] transform translate-x-full transition-transform duration-300 ease-in-out z-50">
      ...
      <div class="p-4">
          <ul role="menu" class="space-y-1">
              <li class="relative group">
                  <a href="#" class="block px-3 py-2 hover:bg-gray-100">Media Corner</a>
                  <ul class="submenu pl-4 bg-white shadow-md submenu" role="menu">
                      <li><a href="#" class="block px-3 py-2 hover:bg-gray-100">News</a></li>
                      <li><a href="#" class="block px-3 py-2 hover:bg-gray-100">Press Release</a></li>
                      <li><a href="#" class="block px-3 py-2 hover:bg-gray-100">Photo Gallery</a></li>
                      <li><a href="#" class="block px-3 py-2 hover:bg-gray-100">Video Gallery</a></li>
                  </ul>
              </li>
          </ul>
      </div>
